...
def learn_new_topic():
    """
    # This is the main function. The purpose of this program is to give a user the ability to learn new topics. The user can enter a topic and the program will extract data from the topic and return it to the user.
    """
    topic = input("Topic = ")
